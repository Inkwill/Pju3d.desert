...
namespace CreatorKitCodeInternal
{
		...
		IBeginDragHandler, IDragHandler, IEndDragHandler
	{
		...
		public UIInventoryWindow Owner { get; set; }
		...
		public void OnPointerClick(PointerEventData eventData)
		{
			...
			// 	if (InventoryEntry != -1)
			// 	{
			// 		if (GameManager.CurHero.Inventory.Entries[InventoryEntry] != null)
			// 			Owner.ObjectDoubleClicked(GameManager.CurHero.Inventory.Entries[InventoryEntry]);
			// 	}
			// 	else
			// 	{
		...
		{
			var entry = GameManager.CurHero.Inventory.Entries[InventoryEntry];
