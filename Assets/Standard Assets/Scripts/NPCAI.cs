...
public class NPCAI : RoleAI
{
    ...
    public bool PickItem
    {
        ...
        {
            m_itemPick = value;
            if (m_itemPick) m_role.Interactor?.OnItemEnter.AddListener(OnItemEnter);
            else m_role.Interactor?.OnItemEnter.RemoveListener(OnItemEnter);
        }
    }
    bool m_itemPick;
    public override void Init()
    {
        ...
        switch (camp)
        {
            case NPCAI.Camp.ENEMY:
                ...
                m_role.Interactor.layers = LayerMask.GetMask("Noting");
                break;
            case NPCAI.Camp.NEUTRAL:
                ...
                m_role.Interactor.layers = LayerMask.GetMask("Player", "Neutral");
                m_Offensive = false;
                break;
            default:
                break;
    ...
    protected override void OnRoleEvent(GameObject obj, string eventName)
    {
        ...
        {
            if (m_role.Interactor.Interacting) return;
